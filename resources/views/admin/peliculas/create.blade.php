...
<script src="//cdn.ckeditor.com/4.21.0/standard/ckeditor.js"></script>
   ...
   <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Nueva pelicula</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                 <form action="{{url('/admin/peliculas')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="trailer_p" class="form-control" value="{{ old('trailer_p') }}" required>
                                        @error('trailer_p')
                                            <small style="color: red ">{{$message}}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="link1_p" class="form-control" value="{{ old('link1_p') }}" required>
                                @error('link1_p')
                                            <small style="color: red ">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="link2_p" class="form-control" value="{{ old('link2_p') }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="">Description de la pelicula <span style="color: red"><b>*</b></span></label>
                                <textarea name="description_p" id="" cols="30" rows="5" class="form-control"  required>{{ old('description_p') }}</textarea>
                                @error('description_p')
                                            <small style="color: red ">{{$message}}</small>
                                @enderror
                                <script>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="imagenes_p" id="file" class="form-control" value="{{ old('imagenes_p') }}" required>
                                @error('imagenes_p')
                                  <small style="color: red ">{{$message}}</small>
                                @enderror
                                <br>
                    ...
                    <div class="row">
                        <div class="md-6">
                            <a href="{{url('admin/peliculas')}}" class="btn btn-secondary">Cancelar</a>
